...
import com.mywear.adapter.BleAdapter;
import com.mywear.adapter.LayoutAdapter;
...
public class MainActivity extends AppCompatActivity {
    ...
    ListView bleListView;  //可连接蓝牙设备列表的listview
    ListView layoutListView;  //可选操作的listview
    Button start_scan;
    //以下为第二个layout
    ...
    private List<ListItem> LayoutList;  //提供可选项
    ...
    private void initData() {
        ...
        ListItem map = new ListItem(R.drawable.map_pic);
        LayoutList.add(map);
        LayoutAdapter adapter = new LayoutAdapter(MainActivity.this,
               R.layout.layout_list_item, LayoutList);
        layoutListView = (ListView) findViewById(R.id.option_view);
    ...
    private void initView(){
        ...
        operaView=findViewById(R.id.opera_view);  //读写操作的layout
    ...
    private BluetoothGattCallback gattCallback=new BluetoothGattCallback() {
        ...
        public void onServicesDiscovered(BluetoothGatt gatt, int status) {
            ...
            runOnUiThread(new Runnable() {
                @Override
                public void run() {
                    bleListView.setVisibility(View.GONE);  //在这儿设置了列表不可见，文本框可见
